...
module.exports = {
  ...
  themeConfig: {
    ...
    // 博主信息，显示在首页侧边栏
    blogger: {
      avatar: 'https://cdn.jsdelivr.net/gh/caococos/resource-set@master/img/Elis.jpg',
      name: 'Zhihaot1',
      slogan: '唯爱与双马尾不可辜负！',
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'zhihaot1,前端博客,个人技术博客,前端,前端开发,前端框架,web前端,前端面试题,技术文档,学习,面试,JavaScript,js,ES6,TypeScript,vue,python,css3,html5,Node,git,github,markdown',
      },
    ],
