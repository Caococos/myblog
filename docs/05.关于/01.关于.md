...
<!-- 小熊猫 -->
<img src="https://cdn.jsdelivr.net/gh/caococos/resource-set@master/img/panda-waving.png" class="panda no-zoom" style="width: 130px;height: 115px;opacity: 0.8;margin-bottom: -4px;padding-bottom:0;position: fixed;bottom: 0;left: 0.5rem;z-index: 1;">
...
## Funny
`双马尾之辩`是本人守望id，欢迎小伙伴一起玩耍，Friends:`中国老王`、`美女且18`、`bate`、`你害怕了吗`

<img src="https://cdn.jsdelivr.net/gh/caococos/resource-set@v1.1.0/img/beauty2.jpg"  style="width:370px;" />
...
- WeChat or QQ: <a :href="qqUrl" class='qq'>zhihaot1</a>
- Email:  <a href="mailto:894072666@qq.com">zhihaot1@qq.com</a>
- GitHub: <https://github.com/Caococos>
...
<script>
  export default {
    data(){
      return {
        qqUrl: 'tencent://message/?uin=493524673&Site=&Menu=yes'
      }
    },
    mounted(){
